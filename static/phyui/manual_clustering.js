define(function (require) {
    ...
    events.on('kernel_connected.Kernel', function(){
        ...
        myhack.create_result_cell('#placeholder1', "from phyui import start_manual_clustering; session = start_manual_clustering('/home/ctaf/src/cortex/data/test_hybrid_120sec.kwik', backend='ipynb_webgl')");
